...
const GridGlobe = () => {
  ...
  const colors = ["#e4c1f9", "#e4c1f9", "e4c1f9"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    ...
    <div className="flex items-center justify-center absolute top-0 left-0 w-full h-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-96 md:h-[40rem] px-4">
        <div className="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none  z-40" />
        <div className="absolute top-[50%] left-[80%] transform -translate-x-1/2 -translate-y-1/2 w-full h-full z-10">
